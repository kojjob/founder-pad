defmodule LinkHub.Billing.Workers.StripeHandlerTest do
  ...
  describe "checkout.session.completed" do
    test "creates subscription for the workspace" do
  ...
  describe "customer.subscription.updated" do
    test "updates subscription status" do
      ...
      {:ok, updated} = Ash.get(LinkHub.Billing.Subscription, subscription.id)
  ...
  describe "customer.subscription.deleted" do
    test "marks subscription as canceled" do
      ...
      {:ok, canceled} = Ash.get(LinkHub.Billing.Subscription, subscription.id)
