defmodule FounderPad.AnalyticsTest do
  use FounderPad.DataCase, async: true

  alias FounderPad.Analytics
  alias FounderPad.Analytics.{AppEvent, SearchConsoleData}
  ...
  describe "AppEvent tracking" do
    ...
    test "broadcasts event to org channel" do
      org = create_organisation!()
      Phoenix.PubSub.subscribe(FounderPad.PubSub, "org_events:#{org.id}")
