defmodule FounderPad.NotificationsTest do
  use FounderPad.DataCase, async: true

  alias FounderPad.Notifications.{Notification, EmailLog}
  ...
  describe "PubSub broadcast" do
    test "broadcasts notification to user channel" do
      Phoenix.PubSub.subscribe(FounderPad.PubSub, "user_notifications:test-user-id")

      FounderPad.Notifications.broadcast_to_user("test-user-id", %{
        type: :team_invite,
        title: "Test"
      })
