defmodule Mix.Tasks.FounderPad.Seed do
  @moduledoc """
  Seeds the database with sample data for development.

      mix founder_pad.seed
  """
  use Mix.Task
  ...
  def run(_args) do
    ...
    Mix.shell().info("🌱 Seeding FounderPad development data...")
  ...
  defp seed_demo_data do
    ...
    {:ok, org} =
      Organisation
      |> Ash.Changeset.for_create(:create, %{name: "FounderPad Demo"})
      |> Ash.create()

    Mix.shell().info("  Created demo org: FounderPad Demo")
  ...
  defp seed_feature_flags do
    alias FounderPad.FeatureFlags.FeatureFlag
