defmodule LinkHub.Billing.Plan do
  @moduledoc "Ash resource representing a billing plan."
  use Ash.Resource,
  ...
  attributes do
    ...
    attribute(:max_file_size_bytes, :integer, default: 20_000_000, public?: true)
    attribute(:max_storage_bytes, :integer, public?: true)
