defmodule FounderPadWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FounderPadWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FounderPadWeb.Gettext, "errors", msg, opts)
    end
  end
        ...
        <div class="pt-8 border-t border-outline-variant/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div class="flex items-center gap-2.5">
            ...
            <span class="text-xs font-mono text-on-surface-variant">
              &copy; {DateTime.utc_now().year} FounderPad. All rights reserved.
            </span>
          </div>
