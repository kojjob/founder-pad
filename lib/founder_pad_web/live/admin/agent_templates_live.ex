  ...
  def render(assigns) do
    ...
    <div class="space-y-8 max-w-6xl mx-auto">
      <div class="flex items-center justify-between">
        ...
        <button
          phx-click="new"
          class="px-5 py-2.5 primary-gradient rounded-lg text-sm font-semibold flex items-center gap-2"
        >
      ...
      <%= if @editing do %>
        <div class="bg-surface-container rounded-2xl p-6">
          <h2 class="text-lg font-bold text-on-surface mb-4">
            {if @editing == :new, do: "Create Template", else: "Edit Template"}
          </h2>
          <form phx-submit="save" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  value={@form["name"]}
                  required
                  class="w-full px-3 py-2 bg-surface-container-high border border-outline-variant rounded-lg text-on-surface"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <textarea
                ...
                rows="4"
                class="w-full px-3 py-2 bg-surface-container-high border border-outline-variant rounded-lg text-on-surface font-mono text-sm"
              >{@form["system_prompt"]}</textarea>
            </div>
            <div class="flex gap-3">
              ...
              <button
                type="button"
                phx-click="cancel"
                class="px-5 py-2.5 bg-surface-container-high hover:bg-surface-container-highest text-on-surface rounded-lg text-sm font-semibold"
              >
                Cancel
              </button>
            </div>
