defmodule FounderPadWeb.Docs.ApiSpecsLive do
  use FounderPadWeb, :live_view

  def mount(_params, _session, socket) do
    {:ok,
     assign(socket,
       page_title: "API Reference -- FounderPad",
       endpoints: endpoints(),
       expanded: MapSet.new(),
       active_group: nil
     ), layout: false}
      ...
      <div class="pt-20 max-w-7xl mx-auto px-6">
        ...
        <div class="py-12 mb-8">
          ...
          <p class="text-on-surface-variant text-lg leading-relaxed max-w-2xl">
            Complete reference for the FounderPad REST and GraphQL APIs. All endpoints
    ...
    |> Enum.map(fn line ->
      ...
      colored =
        cond do
          ...
          String.starts_with?(String.trim(line), "curl") ->
            escaped
