defmodule LinkHubWeb.AgentsLive do
  @moduledoc "LiveView for listing and managing AI agents."
  ...
  defp compute_fleet_stats(agents) do
    ...
    conversations = safe_count(LinkHub.AI.Conversation)
    usage = safe_count(LinkHub.Billing.UsageRecord)
