defmodule LinkHubWeb.Docs.ChangelogLive do
  @moduledoc "LiveView for displaying the product changelog."
      ...
      <div class="pt-20 max-w-3xl mx-auto px-6">
        ...
        <div class="py-16 text-center">
          ...
          <p class="text-on-surface-variant text-lg leading-relaxed max-w-xl mx-auto">
            Every update, improvement, and fix shipped to LinkHub.
