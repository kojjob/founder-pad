defmodule LinkHubWeb.BillingLive do
  @moduledoc "LiveView for billing plans, subscriptions, and invoices."
  ...
  defp count_org_usage(org_id) do
    case LinkHub.Billing.UsageRecord
  ...
  defp get_user_org_id(user) do
    case LinkHub.Accounts.Membership
         ...
         |> Ash.Query.limit(1)
         |> Ash.read() do
      {:ok, [membership | _]} -> membership.workspace_id
      _ -> nil
    end
  end
