defmodule LinkHubWeb.Auth.LoginLive do
  @moduledoc "LiveView for user login."
      ...
      <main class="flex-1 flex items-center justify-center p-4">
        <div class="w-full max-w-md space-y-8">
          ...
          <div class="text-center">
            ...
            <p class="text-on-surface-variant mt-2">Sign in to your LinkHub account</p>
          </div>
  ...
  def handle_event("login", %{"user" => params}, socket) do
    strategy = AshAuthentication.Info.strategy!(LinkHub.Accounts.User, :password)
    ...
    case AshAuthentication.Strategy.action(strategy, :sign_in, %{
      ...
      {:ok, user} ->
        ...
        try do
          ...
          LinkHub.Audit.log(:login, "User", to_string(user.id), user.id, nil,
            user_agent: ua,
            ip_address: "unknown"
          )
        rescue
