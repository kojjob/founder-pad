defmodule LinkHubWeb.CheckoutController do
  @moduledoc "Stripe checkout session controller."
  ...
  defp create_checkout_session(plan, _conn) do
    case Application.get_env(:stripity_stripe, :api_key) do
      ...
      _key ->
        params = %{
          mode: "subscription",
          success_url: LinkHubWeb.Endpoint.url() <> "/billing?success=true",
          cancel_url: LinkHubWeb.Endpoint.url() <> "/billing?canceled=true",
